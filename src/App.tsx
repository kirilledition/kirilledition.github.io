...
import { ArrowDown, ArrowUp, Github, Linkedin, Mail, GraduationCap, Briefcase, Trophy } from "lucide-react";
...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section 
        id="home"
        className="relative min-h-screen flex flex-col px-8 py-8 md:px-12 md:py-12 max-w-3xl mx-auto"
        style={{
          background: "linear-gradient(to bottom, #000000 0%, #000000 45%, #F4F4F0 65%, #F4F4F0 100%)",
      ...
      >
        <header className="flex-grow flex flex-col justify-start pt-16 pb-12">
          <motion.h1 
            ...
            className="font-serif text-[64px] md:text-[84px] leading-[0.9] tracking-tight text-paper"
          >
            hello, <br />
            my name is / <br />
        ...
        <nav className="flex flex-col w-full">
          {sections.slice(1).map((section) => (
            <a
              ...
              onMouseEnter={(e) => {
                const bg = e.currentTarget.querySelector('.blob-bg') as HTMLElement;
            ...
            >
              <div className="blob-bg absolute inset-2 md:inset-3 bg-ink opacity-0 group-hover:opacity-100 transition-all duration-1000 ease-in-out z-0" style={{ borderRadius: '20px' }}></div>
      ...
      <section id="about" className="bg-paper px-8 py-12 md:py-20 md:px-12 max-w-3xl mx-auto">
        ...
        >
          <img 
            src="https://lh3.googleusercontent.com/aida/ADBb0ugoxWkvCBbZXLzGiZ377jfuljIKDkimTLavMLSoa44FVhF2VVKXwVzwioIL7zWOc45zf96EKxFxlMCsQG-PTnER2HZvJKgqlDbut_cPwunzV134AX5gaX9JxvmbNmpf921ffPxsFuRhmsn6Jv8XaD6rVG15P0vIobd5R4FyZOegANu9r5LXYyFFiosoSWpAshCMEOmg0ml3EJKZ9P_NWlf1H3A3JQHuNtq2BORkLQyPHFnXoBwDfMM0MACYRKyp3RKDARdgsJeb"
            alt="Kirill Denisov"
            ...
            <ul className="flex flex-col gap-8">
              {[
                { 
                  ...
                  period: "2026—Present", 
                  current: true,
                  description: "Translational AI research focusing on ML-based biomarkers for aging, mental health, and cognition."
                },
                { 
                  title: "Senior Researcher, Gero", 
                  period: "2020—2026",
                  description: "Led research initiatives in aging and longevity, utilizing machine learning to discover thermodynamic control variables and epigenetic clocks."
                },
                { 
                  title: "Undergraduate Researcher, RAS", 
                  period: "2018—2020",
                  description: "Participated in foundational research projects at the Russian Academy of Sciences during undergraduate studies."
                },
              ].map((exp, i) => (
                <li key={i} className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col w-full gap-1">
                    ...
                    {exp.description && <p className="text-[14px] md:text-[15px] leading-relaxed text-ink/80">{exp.description}</p>}
                  </div>
                </li>
              ))}
            </ul>
            ...
            <ul className="flex flex-col gap-8">
              {[
                { 
                  ...
                  period: "2026—2030",
                  description: "National University of Singapore. Focusing on ML-based biomarkers for aging and mental health."
                },
                { 
                ...
                <li key={i} className="flex items-start gap-4">
                  ...
                  <div className="flex flex-col w-full gap-1">
                    ...
                    {edu.description && <p className="text-[14px] md:text-[15px] leading-relaxed text-ink/80">{edu.description}</p>}
                  </div>
                </li>
              ))}
            </ul>
      ...
      {/* Contact Section */}
      <section id="contact" className="bg-paper px-8 py-12 md:py-20 md:px-12 max-w-3xl mx-auto flex flex-col items-start">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-12 w-full mb-16 md:mb-32">
          <div className="flex flex-col gap-2">
            <span className="text-[10px] tracking-[0.2em] text-[#737373] uppercase font-sans font-semibold">Professional</span>
            <a href="https://www.linkedin.com/in/kirilldenisov" target="_blank" rel="noopener noreferrer" className="font-serif text-[32px] md:text-[40px] uppercase border-b border-ink/30 pb-1 hover:border-ink transition-colors w-fit leading-none">
              LINKEDIN
            </a>
          </div>
          <div className="flex flex-col gap-2 mt-16">
            <span className="text-[10px] tracking-[0.2em] text-[#737373] uppercase font-sans font-semibold">Thought</span>
            <a href="https://x.com/kirilledition" target="_blank" rel="noopener noreferrer" className="font-serif italic text-[32px] md:text-[40px] border-b border-ink/30 pb-1 hover:border-ink transition-colors w-fit leading-none">
              X.com
            </a>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-[10px] tracking-[0.2em] text-[#737373] uppercase font-sans font-semibold">Academic</span>
            <a href="https://scholar.google.com/citations?hl=en&user=bU3x6fkAAAAJ" target="_blank" rel="noopener noreferrer" className="font-serif text-[32px] md:text-[40px] border-b border-ink/30 pb-1 hover:border-ink transition-colors w-fit leading-none">
              Scholar
            </a>
          </div>
          <div className="flex flex-col gap-2 mt-16">
            <span className="text-[10px] tracking-[0.2em] text-[#737373] uppercase font-sans font-semibold">Code</span>
            <a href="https://github.com/kirilldenisov" target="_blank" rel="noopener noreferrer" className="font-serif italic text-[32px] md:text-[40px] uppercase border-b border-ink/30 pb-1 hover:border-ink transition-colors w-fit leading-none">
              GITHUB
            </a>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-[10px] tracking-[0.2em] text-[#737373] uppercase font-sans font-semibold">Correspondence</span>
            <a href="mailto:kirill.denisov700@gmail.com" className="font-serif text-[32px] md:text-[40px] uppercase border-b border-ink/30 pb-1 hover:border-ink transition-colors w-fit leading-none">
              EMAIL
            </a>
          </div>
        </div>
        ...
        <div className="flex flex-col items-center gap-4 w-full">
          <a href="#" className="font-sans font-bold text-[32px] md:text-[48px] uppercase tracking-tight border-b-4 border-ink pb-2 hover:opacity-70 transition-opacity leading-none">
            BOOK A CALL
          </a>
      ...
      <section id="publications" className="bg-paper px-8 py-12 md:py-20 md:px-12 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col border-t border-ink">
          {[
            { 
              year: "2025", 
              title: "AI-Driven Identification of Exceptionally Efficacious Polypharmacological Compounds That Extend the Lifespan of Caenorhabditis elegans", 
              authors: <>Konstantin Avchaciov, Khalyd J. Clay, <span className="font-bold">Kirill A. Denisov</span>, Olga Burmistrova, Michael Petrascheck, Peter O. Fedichev</>,
              journal: "Aging Cell",
            ...
            { 
              ...
              authors: <>Sheng Fong, <span className="font-bold">Kirill A. Denisov</span>, Anastasiia A. Nefedova, Brian K. Kennedy, Jan Gruber</>,
              journal: "npj Aging",
              doi: "10.1038/s41514-025-00221-4"
            },
            { 
              year: "2024", 
              title: "Discovery of Thermodynamic Control Variables that Independently Regulate Healthspan and Maximum Lifespan", 
              authors: <><span className="font-bold">Kirill A. Denisov</span>, Jan Gruber, Peter O. Fedichev</>,
              journal: "bioRxiv",
            ...
            { 
              ...
              authors: <>Andrei E. Tarkhov, <span className="font-bold">Kirill A. Denisov</span>, Peter O. Fedichev</>,
            ...
            >
              ...
              <div className="relative z-10 w-3/5 pr-4 flex flex-col gap-3">
                <p className="font-serif text-[20px] md:text-[24px] leading-tight">
                  {pub.title}
                </p>
